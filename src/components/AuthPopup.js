  ...
  const signUpUser = async (email, password) => {
    try {
      ...
      const initialUserInfo = {
        ...
        rewards: [{ id: 1, title: 'Gift Card', points: 50, moneyCost: 0 },
        { id: 2, title: 'Extra Day Off', points: 100, moneyCost: 0 },],
        tasks: [{ id: 1, title: 'Morning Run', description: 'Run 5km in the morning', category: 'Health', xp: "20" },
        { id: 2, title: 'Finish Project', description: 'Complete the frontend project', category: 'Work', xp: "30" },
        { id: 3, title: 'Read a Book', description: 'Read 50 pages of a book', category: 'Hobbies', xp: "10" },
        { id: 4, title: 'Meditation', description: '15 minutes of meditation', category: 'Self-care', xp: 5 },
        { id: 5, title: 'Call a Friend', description: 'Catch up with a friend', category: 'Friends', xp: 8 },],
